package com.example.mynetdiarytest.utils.glide;
...
public abstract class ProgressTarget<T, Z> extends WrappingTarget<Z> implements MyNetDiaryGlideModule.UIonProgressListener {
    private T model;
    ...
    public final void setModel(T model) {
        GlideApp.with(getView()).clear(this); // indirectly calls cleanup
        this.model = model;
    }
    /**
    ...
    private void start() {
        MyNetDiaryGlideModule.expect(toUrlString(model), this);
    ...
    private void cleanup() {
        ...
        onDelivered();
        MyNetDiaryGlideModule.forget(toUrlString(model));
        this.model = null;
    }

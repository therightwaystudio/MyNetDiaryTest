...
@GlideModule
public class MyNetDiaryGlideModule extends AppGlideModule {
    ...
    public static void forget(String url) {
        MyNetDiaryGlideModule.DispatchingProgressListener.forget(url);
    }

    public static void expect(String url, MyNetDiaryGlideModule.UIonProgressListener listener) {
        MyNetDiaryGlideModule.DispatchingProgressListener.expect(url, listener);
    }
    ...
    private static class DispatchingProgressListener implements MyNetDiaryGlideModule.ResponseProgressListener {
